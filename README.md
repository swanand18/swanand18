...
### 🔹 [Highly Available 3-Tier Web App on AWS](https://github.com/swanand18/ha-3tier-webapp)

A **production-style AWS 3-tier architecture** built with **Terraform, ALB, Auto Scaling Groups, RDS MySQL, Ansible, and GitHub Actions** across multiple Availability Zones.

**Highlights:**

* Highly Available **3-tier architecture**
* **Public / Private subnet** design across 2 AZs
* **External + Internal ALBs**
* **Web Tier + App Tier Auto Scaling**
* **RDS MySQL Multi-AZ**
* **Secrets Manager**, CloudWatch, IAM, and VPC security controls

---

### 🔹 [CI/CD Pipeline Project](https://github.com/swanand18/cicd-pipeline)

A **production-style CI/CD automation pipeline** built using **Jenkins, GitHub Actions, Docker, Ansible, AWS EC2, and AWS S3** to automate build, test, packaging, and deployment workflows.
...
* **Artifact packaging + AWS S3 storage**
...
* **Email:** [swanand.awatade@gmail.com](mailto:swanand.awatade@gmail.com)
